...
const DoctorCard = ({ doctor }) => {
  ...
  return (
    <div className="p-3 lg:p-5">
      ...
      <div className="my-2 lg:mt-4 flex items-center justify-between">
        <span className="bg-[#ccf0f3] text-irisBlueColor py-1 px-2 lg:py-2 lg:px-6 text-[18px] rounded leading-4 lg:text-[16px] lg:leading-7 font-semibold">
          {specialization}
        </span>
      ...
      <div className="mt-[18px] lg:my-5 flex items-center justify-between">
        <div className="">
