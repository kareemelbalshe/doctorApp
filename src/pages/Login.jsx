    ...
    <section className="px-5 lg:px-0">
      <div className="w-full max-w-[570px] mx-auto rounded-lg shadow-md md:p-10">
        ...
        <form action="" onSubmit={submitHandler} className="py-4 md:py-0">
          <div className="mb-5">
            <input
            className="w-full py-3 border-b border-solid border-[#0066ff60] focus:outline-none focus:border-b-primaryColor text-[22px] leading-7 text-headingColor placeholder:text-textColor cursor-pointer"
            required
              type="email"
