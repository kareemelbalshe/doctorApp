...
const Home = () => {
  return (
    <div>
      <section className="hero__section pt-[20px] 2xl:h-[700px]">
            ...
            <div className="">
              <div className="lg:w-[570px]">
                ...
                <p className="text__para">
                  ...
                  Ipsam consectetur mollitia sint id, eligendi praesentium nam
                  facilis! Consequatur temporibus fugit, accusamus nam saepe
                  eveniet reiciendis molestias eum dicta beatae ducimus!
                </p>
              ...
              <div className="w-[150px] lg:w-[240px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-[6px] lg:gap-3">
                    <p
                    className="text-[10px] leading-[10px] lg:text-[14px] lg:leading-5 text-headingColor font-[600]">Tue, 24</p>
                    <p
                    className="text-[10px] leading-[10px] lg:text-[14px] lg:leading-5 text-textColor font-[400]">10:00AM</p>
                  </div>
